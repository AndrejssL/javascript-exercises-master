 ...
 *
 * (Typically, this is followed by, "We're only going to need to run this once." That's then typically followed by much forehead slapping
 * and moaning about how stupid we could possibly be.)
 *
 * The goal
...
//     let lowerCaseLetters = old.toString().toLowerCase();
// }
function transform(old) {
  var result = {};
